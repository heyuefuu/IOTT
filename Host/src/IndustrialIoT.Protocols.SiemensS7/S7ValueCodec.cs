...
public static class S7ValueCodec
{
    ...
    public static S7DataLength GetLength(DataType dataType, ushort stringLength = 16) => dataType switch
    {
        ...
        DataType.Int8 or DataType.UInt8 => S7DataLength.Byte,
        ...
        DataType.Int64 or DataType.UInt64 or DataType.Double => S7DataLength.LWord,
    ...
    public static byte[] GetBytes(DataType dataType, object value, ushort stringLength) => dataType switch
    {
        ...
        DataType.UInt64 => WriteBytes(8, span => BinaryPrimitives.WriteUInt64BigEndian(span, Convert.ToUInt64(value))),
    ...
    public static object FromBytes(ReadOnlySpan<byte> data, DataType dataType) => dataType switch
    {
        ...
        DataType.Int8 => unchecked((sbyte)data[0]),
        ...
        DataType.UInt64 => BinaryPrimitives.ReadUInt64BigEndian(data),
